        ...
        <div class="card-body ">
            <div class="row">
                <div class="col-md-12  d-flex justify-content-between align-items-center">
                  ...
                  <a href="{{route('project.view')}}" class="btn btn-warning text-dark"> <i class="fa fa-list"></i> Project List</a>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-6 offset-3 pt-3">
            <form action="{{route('project.store')}} " method="POST">
                ...
                <div class="form-group">
                    <label for="my-input">Project_Link</label>
                    <input id="my-input" class="form-control" type="text" name="project_link" placeholder="Enter Your Project Link" required>
