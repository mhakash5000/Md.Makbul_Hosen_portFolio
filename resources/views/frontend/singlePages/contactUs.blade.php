...
@section('content')
    <div class="contact-us bg-success">
        <div class="container">
            <div class="row">
            <div class="col-md-12">
                <h3 class="text-light text-center pt-3">PRESENT LOCATION</h3>
        ...
        <div class="row">
            <div class="col-md-12">
                <h3 class=" text-light text-center pt-5">CONTACT WITH ME</h3>
                ...
                <form action="{{route('Contact.Store')}}" method="POST">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="massage" id="" cols="150" rows="8" placeholder="Enter your Massage" required></textarea>
                    </div>
                    <div class="form-group">
